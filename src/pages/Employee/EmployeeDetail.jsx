...
const EmployeeDetail = () => {
  ...
  if (error)
    return <p className="error-text">❌ Error loading employee details.</p>;

  if (!employee)
    return <p className="no-records">No employee record found.</p>;
    ...
    <>
      ...
      <div className="employee-detail">
        ...
        <div className="employee-profile">
          <img
            src={employee.userId?.profile?.url || "/default-profile.png"}
